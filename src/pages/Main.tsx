...
function Main({ currentUser, logOut, users, setModal, modal }: Props) {
  ...
  const usersIHaveNotTalkedToYet: User[] | undefined = users?.filter(user => {
  ...
  if (currentUser === null || users === null || usersIHaveNotTalkedToYet === undefined) return <h1>Not signed in...</h1>
