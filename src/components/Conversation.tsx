...
import {User, ConversationType, MessageType} from '../types'
...
function Conversation({ currentUser }: Props) {
  ...
  if (currentConversation === null || currentUser === null || currentConversation.messages === undefined) return <h1>Loading...</h1>
